...
export const saveFirma = async (
  ...
  const result = await pool.query(
    `
    INSERT INTO acta_firmas (acta_id, tipo, firma_base64, firmante_nombre, firmante_cc)
    VALUES ($1, $2, $3, $4, $5)
    ON CONFLICT (acta_id, tipo) DO UPDATE SET
      ...
      capturada_en = NOW()
    RETURNING id, acta_id, tipo, firmante_nombre, firmante_cc, capturada_en
    `,
    [actaId, tipo, firmaBase64, firmanteNombre ?? null, firmanteCC ?? null],
  );
